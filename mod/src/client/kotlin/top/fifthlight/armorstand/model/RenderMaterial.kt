...
sealed class RenderMaterial : AbstractRefCount() {
    companion object {
        ...
        val PIPELINES = Unlit.PIPELINES + Fallback.pipeline
    }
    ...
    class Pbr(
        ...
        companion object {
            private val TYPE_ID = Identifier.of("armorstand", "material_pbr")
        }
    ...
    class Unlit(
        ...
        companion object {
            private val TYPE_ID = Identifier.of("armorstand", "material_unlit")
    ...
    object Fallback : RenderMaterial() {
        override val typeId: Identifier
            get() = Identifier.of("armorstand", "material_fallback")
        ...
        override val pipeline: RenderPipeline = RenderPipeline.builder(RenderPipelines.MATRICES_COLOR_FOG_SNIPPET)
            .withLocation(Identifier.of("armorstand", "fallback"))
